...
import 'package:flutter_ulearning_1/main.dart';
                ...
                PageView(
                  ...
                  children: [
                    ...
                    _page(
                        ...
                        "Always keep in touch with your tutor let's get connected",
        ...
        GestureDetector(
            onTap: () {
              if (index < 3) {
                ...
                //jump to a new page
                // Navigator.of(context).push(MaterialPageRoute(builder: (context)=>MyHomePage())); //routing to a new page
